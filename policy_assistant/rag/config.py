...
# Per remote address. Shared-office NAT means one address is the whole office,
# so keep these well above one person's pace. Login and escalations keep their
# own hard-coded limits on the route decorators.
