---
name: CMSC495-CAP
description: Working in the CMSC495-CAP repo, the Handbook policy assistant. Stack, layout, commands, code conventions, what CI enforces, and the rules that are easy to break without noticing. Read before changing anything here.
---
